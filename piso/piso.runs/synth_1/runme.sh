...
HD_PWD='C:/Users/50/Desktop/vLabs/piso/piso.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piso.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piso.tcl
