...
HD_PWD='C:/Users/50/Desktop/vLabs/piso/piso.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piso.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piso.tcl -notrace
