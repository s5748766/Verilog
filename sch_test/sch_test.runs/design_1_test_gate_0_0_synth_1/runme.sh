...
HD_PWD='C:/Users/50/Desktop/vLabs/sch_test/sch_test.runs/design_1_test_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_test_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_test_gate_0_0.tcl
