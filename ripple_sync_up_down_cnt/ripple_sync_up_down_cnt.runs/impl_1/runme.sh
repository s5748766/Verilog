...
HD_PWD='C:/Users/50/Desktop/vLabs/ripple_sync_up_down_cnt/ripple_sync_up_down_cnt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_cnt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sync_cnt.tcl -notrace
