...
HD_PWD='C:/Users/50/Desktop/vLabs/ripple_sync_up_down_cnt/ripple_sync_up_down_cnt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_cnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_cnt.tcl
