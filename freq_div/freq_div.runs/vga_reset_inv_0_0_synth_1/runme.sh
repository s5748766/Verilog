...
HD_PWD='C:/Users/50/Desktop/vLabs/freq_div/freq_div.runs/vga_reset_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_reset_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_reset_inv_0_0.tcl
