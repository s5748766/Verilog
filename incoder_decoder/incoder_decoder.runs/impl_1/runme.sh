...
HD_PWD='C:/Users/50/Desktop/vLabs/incoder_decoder/incoder_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_enc_dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_enc_dec.tcl -notrace
