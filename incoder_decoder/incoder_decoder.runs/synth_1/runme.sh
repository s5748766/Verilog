...
HD_PWD='C:/Users/50/Desktop/vLabs/incoder_decoder/incoder_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_enc_dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_enc_dec.tcl
