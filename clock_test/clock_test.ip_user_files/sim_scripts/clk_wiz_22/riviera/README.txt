...
#
# Generated by export_simulation on Thu Oct 23 12:12:09 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_22.sh' script.

./clk_wiz_22.sh -reset_run
...
./clk_wiz_22.sh -noclean_files

For more information on the script, please type './clk_wiz_22.sh -help'.
