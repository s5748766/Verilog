...
HD_PWD='C:/Users/50/Desktop/vLabs/clock_test/clock_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_test.tcl
