...
HD_PWD='C:/Users/50/Desktop/vLabs/clock_test/clock_test.runs/clk_wiz_22_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_22.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_22.tcl
