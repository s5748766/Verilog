...
HD_PWD='C:/Users/50/Desktop/vLabs/clock_test/clock_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_test.tcl -notrace
