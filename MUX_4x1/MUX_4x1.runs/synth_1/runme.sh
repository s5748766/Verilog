...
HD_PWD='C:/Users/50/Desktop/vLabs/MUX_4x1/MUX_4x1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_mux.tcl
