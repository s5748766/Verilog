...
HD_PWD='C:/Users/50/Desktop/vLabs/MUX_4x1/MUX_4x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_mux.tcl -notrace
