...
HD_PWD='C:/Users/50/Desktop/vLabs/4bit_bin_up_counter/4bit_bin_up_counter.runs/design_1_jk_ff_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_jk_ff_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_jk_ff_3_0.tcl
